...
## DXR
* Windows SDK WindowsTargetPlatformVersion=10.0.17763.0
data files go in solution folder 
have to run in dx12 mode (+set r_renderAPI 2 )
right click "render" progect, slecet "Manage NuGet Packages", install  WinPixEventRuntime.1.0.190604001
added "dxcapi.h"
only enter level from commandline
